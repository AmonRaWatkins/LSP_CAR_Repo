...
ArrayList<Integer>();
	...
	public int largest() {
		if(set.isEmpty()) {
			throw new IllegalStateException("Set is empty"); // throw an exception if the set is empty 
		}
	...
	public int smallest() {
		if (set.isEmpty()) {
			throw new IllegalStateException("Set is empty"); //exception if the set is empty
		}
